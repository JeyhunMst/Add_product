...
// const changeInpts=document.querySelectorAll(".changable");

// for (let i = 0; i < changeInpts.length; i++) {
//     changeInpts[i].addEventListener("click",()=>{
//         products.forEach((product)=>{
//             if (changeInpts[i].classList.contains(`id${product.id}`)) {
//                 product.namePrd=changeInpts[i].value;
//             }
//         })
//         tableElements.innerHTML=`
//             <tr class="head-tr">
